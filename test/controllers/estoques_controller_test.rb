...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference("Estoque.count") do
      post estoques_url, params: { estoque: { data_reposicao: @estoque.data_reposicao, id_produto: @estoque.id_produto, quantidade_disponivel: @estoque.quantidade_disponivel } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { data_reposicao: @estoque.data_reposicao, id_produto: @estoque.id_produto, quantidade_disponivel: @estoque.quantidade_disponivel } }
