...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { nome: @produto.nome, preco_unitario: @produto.preco_unitario } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { nome: @produto.nome, preco_unitario: @produto.preco_unitario } }
