...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { data_venda: @venda.data_venda, id_cliente: @venda.id_cliente, valor_total: @venda.valor_total } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { data_venda: @venda.data_venda, id_cliente: @venda.id_cliente, valor_total: @venda.valor_total } }
